...
# Write the ACTUAL HTML entities as strings - using the entity codes
new_esc = """function esc(str) {
  return String(str || '').replace(/[&<>"']/g, c =>
    ({'&':'&','<':'<','>':'>','"':'"',"'":'''}[c]));
}"""

# Replace everything from "function esc" to end
...
print('Done fixing both files with proper HTML entities')